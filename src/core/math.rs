...
#[doc = " Calculates INT8 cosine similarity between two vectors."]
#[doc = ""]
#[doc = " Hardware Acceleration:"]
#[doc = " - AARCH64: Uses NEON intrinsics (vmull_s8, vaddq_s32, vpaddlq_s16)"]
#[doc = " - Other: Uses scalar fallback"]
